...
#ifndef LIBDCP_ASSERT_H
#define LIBDCP_ASSERT_H 1
...
#    define ldcp_assert(a)                                                                                             \
        if (!(a)) {                                                                                                    \
            fprintf(stderr, "FATAL ERROR:\n");                                                                         \
            fprintf(stderr, "    libdcp experienced an unrecoverable error and terminates the program\n");             \
